import {Component, OnInit, ChangeDetectorRef, Signal, signal, OnDestroy} from '@angular/core';
import {
  FormArray,
  FormGroup,
  FormControl,
...
export class PocketCreatureEditorComponent implements OnInit, OnDestroy {
