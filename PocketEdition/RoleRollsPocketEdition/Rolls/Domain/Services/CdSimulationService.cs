...
public class CdSimulationService : ICdSimulationService
{
    ...
    private readonly ILogger<CdSimulationService> _logger;

    public CdSimulationService(ILogger<CdSimulationService> logger)
    {
        _logger = logger;
    }
