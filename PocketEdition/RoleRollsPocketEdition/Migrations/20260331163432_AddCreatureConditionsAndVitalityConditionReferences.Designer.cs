...
namespace RoleRollsPocketEdition.Migrations
{
    ...
    [Migration("20260331163432_AddCreatureConditionsAndVitalityConditionReferences")]
    partial class AddCreatureConditionsAndVitalityConditionReferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Bonuses.Bonus", b =>
                {
                    ...
                    b.Property<Guid?>("CreatureConditionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatureConditionId");
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Creatures.Entities.Defense", b =>
                {
                    ...
                    b.Property<string>("FormulaTokens")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Spells.Entities.SpellCircle", b =>
                {
                    ...
                    b.Property<byte[]>("EffectDescription")
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Templates.Entities.CreatureCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Bonuses.Bonus", b =>
                {
                    ...
                    b.HasOne("RoleRollsPocketEdition.Templates.Entities.CreatureCondition", null)
                        .WithMany("Bonuses")
                        .HasForeignKey("CreatureConditionId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("RoleRollsPocketEdition.Templates.Entities.VitalityTemplate", b =>
                {
                    ...
                    b.OwnsOne("RoleRollsPocketEdition.Core.Entities.Property", "ConditionAtThirtyPercent", b1 =>
                        {
                            b1.Property<Guid>("VitalityTemplateId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("VitalityTemplateId");

                            b1.ToTable("VitalityTemplates");

                            b1.WithOwner()
                                .HasForeignKey("VitalityTemplateId");
                        });

                    b.OwnsOne("RoleRollsPocketEdition.Core.Entities.Property", "ConditionAtZero", b1 =>
                        {
                            b1.Property<Guid>("VitalityTemplateId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("ConditionAtThirtyPercent");

                    b.Navigation("ConditionAtZero");
                });
