        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CampaignTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                    ArmorPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    BasicAttackTargetFirstLifeId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeLightWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeMediumWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeHeavyWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeLightWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeMediumWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    MeleeHeavyWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedLightWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedMediumWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedHeavyWeaponHitPropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedLightWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedMediumWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RangedHeavyWeaponDamagePropertyId = table.Column<Guid>(type: "uuid", nullable: true),
                    BasicAttackTargetSecondLifeId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MinorSkillTemplates_AttributeTemplates_AttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MinorSkillTemplates_AttributeId",
