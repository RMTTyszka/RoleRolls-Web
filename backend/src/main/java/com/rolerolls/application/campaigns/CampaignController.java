package com.rolerolls.application.campaigns;

import com.rolerolls.application.campaigns.dtos.AddPlayerAndHeroToCampaignInput;
import com.rolerolls.application.campaigns.dtos.CampaignInvitation;
import com.rolerolls.application.campaigns.dtos.HeroNotFromAddedPlayerException;
import com.rolerolls.application.campaigns.dtos.PlayerInvitationsOutput;
import com.rolerolls.application.campaigns.mappers.CampaignMapper;
import com.rolerolls.application.combats.dtos.CombatListDto;
import com.rolerolls.domain.campaigns.*;
import com.rolerolls.domain.campaigns.rolls.CampaignRollHistoricRepository;
