package com.rolerolls.application.items.equipables.gloves.instances;


import com.rolerolls.domain.items.equipables.gloves.instances.GloveInstance;
import com.rolerolls.domain.items.equipables.gloves.instances.GloveInstanceRepository;
